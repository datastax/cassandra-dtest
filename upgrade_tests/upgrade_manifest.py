...
current_dse_6_9 = VersionMeta(name='current_dse_6_9', family=DSE_6_8, variant='current', version='6.9.21', min_proto_v=3, max_proto_v=4, java_versions=(11,)) # FIXME also support proto_v=65+66 ("dse-v1" and "dse-v2")
