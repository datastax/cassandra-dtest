...
>>>>>>> 679c806d (HCD-120 Add upgrade paths to cc4 and cc5, from C* and DSE)
...
current_dse_6_8 = VersionMeta(name='current_dse_6_8', family=DSE_6_8, variant='current', version='6.8.60', min_proto_v=3, max_proto_v=4, java_versions=(8,)) # FIXME also support proto_v=65+66 ("dse-v1" and "dse-v2")
...
current_dse_6_9 = VersionMeta(name='current_dse_6_9', family=DSE_6_8, variant='current', version='6.9.15', min_proto_v=3, max_proto_v=4, java_versions=(11,)) # FIXME also support proto_v=65+66 ("dse-v1" and "dse-v2")
